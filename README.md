...
**Phase 4（当前）**：Redis 能力层。已落地 Redis compose / health smoke、跨实例 progress pub/sub、短 TTL idempotency guard 和 result apply lease；下一步补限流，不替代 Kafka 的 durable task/result transport。
