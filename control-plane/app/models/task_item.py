...
class TaskItem(Base):
    ...
    target_name_raw: Mapped[str] = mapped_column(String(128), nullable=False, default="")
    target_name_matched: Mapped[str] = mapped_column(String(128), nullable=False, default="")
    document_type: Mapped[str] = mapped_column(String(128), nullable=False, default="")
    category_name: Mapped[str] = mapped_column(String(128), nullable=False, default="")
    dst_dir: Mapped[str] = mapped_column(String(512), nullable=False, default="")
    dst_path: Mapped[str] = mapped_column(String(1024), nullable=False, default="")
