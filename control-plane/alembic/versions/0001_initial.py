...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("team_name_raw", sa.String(128), nullable=False, server_default=""),
        sa.Column("team_name_matched", sa.String(128), nullable=False, server_default=""),
        sa.Column("task_name", sa.String(128), nullable=False, server_default=""),
        sa.Column("category_name", sa.String(128), nullable=False, server_default=""),
        sa.Column("drive_dir", sa.String(512), nullable=False, server_default=""),
        sa.Column("drive_path", sa.String(1024), nullable=False, server_default=""),
